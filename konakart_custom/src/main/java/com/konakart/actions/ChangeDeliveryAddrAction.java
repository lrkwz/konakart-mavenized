 ...
 */
public class ChangeDeliveryAddrAction extends BaseAction
{
    /**
     * 
     * @param mapping
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        try
        {
            ...
            kkAppEng.nav.add(getCatMessage(request, "header.change.shipping.address"), request);

            return mapping.findForward("ChangeDeliveryAddrPage");

 ...
 */
public class ChangePaymentAddrAction extends BaseAction
{
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            kkAppEng.nav.add(getCatMessage(request, "header.change.billing.address"), request);

            return mapping.findForward("ChangePaymentAddrPage");

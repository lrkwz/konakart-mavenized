...
import com.konakart.forms.ChangePasswordForm;
...
public class ChangePasswordSubmitAction extends BaseAction
{
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            ChangePasswordForm localForm = (ChangePasswordForm) form;
            ...
            kkAppEng.getCustomerMgr().changePassword(localForm.getCurrentPassword(),
                    localForm.getNewPassword());

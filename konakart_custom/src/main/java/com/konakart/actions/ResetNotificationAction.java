 ...
 */
public class ResetNotificationAction extends BaseAction
{
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            custId = this.loggedIn(request, response, kkAppEng, "ResetNotification");
            ...
            if (kkAppEng.getProductMgr().getSelectedProduct() != null)
            {
                kkAppEng.getCustomerMgr().deleteProductNotificationsFromCustomer(
                        kkAppEng.getProductMgr().getSelectedProduct().getId());
            }

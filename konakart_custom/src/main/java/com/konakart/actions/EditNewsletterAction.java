 ...
 */
public class EditNewsletterAction extends BaseAction
{
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            kkAppEng.nav.add(getCatMessage(request, "header.newsletter.subscriptions"), request);
            return mapping.findForward("EditNewsletterPage");

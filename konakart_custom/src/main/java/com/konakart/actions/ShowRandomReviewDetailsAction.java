 ...
 */
public class ShowRandomReviewDetailsAction extends BaseAction
{
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            kkAppEng.getReviewMgr().fetchRandomReviewDetails();

            kkAppEng.nav.set(getCatMessage(request, "header.review.details"), request);
            return mapping.findForward("ShowRandomReviewDetails");

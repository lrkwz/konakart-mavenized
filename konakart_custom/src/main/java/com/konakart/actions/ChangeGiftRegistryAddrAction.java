 ...
 */
public class ChangeGiftRegistryAddrAction extends BaseAction
{
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            kkAppEng.nav.add(getCatMessage(request, "header.change.giftregistry.address"), request);

            return mapping.findForward("ChangeGiftRegistryAddrPage");

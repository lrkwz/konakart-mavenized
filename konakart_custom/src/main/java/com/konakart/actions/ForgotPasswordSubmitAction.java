...
import com.konakart.forms.ForgottenPasswordForm;
...
public class ForgotPasswordSubmitAction extends BaseAction
{
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            ForgottenPasswordForm localForm = (ForgottenPasswordForm) form;
            ...
            msgs.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage(
                    "forgotten.password.body.sentpw"));
        ...
        {
            return getForward(mapping, request, e, "com.konakart.app.KKUserDoesntExistException",
                    getCatMessage(request, "forgotten.password.body.usernotfound"), "Error");
        }

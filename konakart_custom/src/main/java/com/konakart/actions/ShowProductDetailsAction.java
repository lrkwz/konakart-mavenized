...
public class ShowProductDetailsAction extends BaseAction
{
            ...
            KKAppException
    {
        ...
        title = title.replace("$category", selectedCat.getName());
        title = title.replace("$manufacturer", selectedProd.getManufacturerName());
        title = title.replace("$name", selectedProd.getName());
        title = title.replace("$model", selectedProd.getModel());
        kkAppEng.setPageTitle(title);

        // Set the meta description
        String description = getCatMessage(request, "seo.product.meta.description.template");
        description = description.replace("$category", selectedCat.getName());
        description = description.replace("$manufacturer", selectedProd.getManufacturerName());
        description = description.replace("$name", selectedProd.getName());
        description = description.replace("$model", selectedProd.getModel());
        kkAppEng.setMetaDescription(description);

        // Set the meta keywords
        String keywords = getCatMessage(request, "seo.meta.keywords.template");
        keywords = keywords.replace("$category", selectedCat.getName());
        keywords = keywords.replace("$manufacturer", selectedProd.getManufacturerName());
        keywords = keywords.replace("$name", selectedProd.getName());
        keywords = keywords.replace("$model", selectedProd.getModel());
        ...
        kkAppEng.nav.add(selectedProd.getName(), "/SelectProd.do?prodId=" + selectedProd.getId());

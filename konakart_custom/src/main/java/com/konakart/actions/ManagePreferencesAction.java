 ...
 */
public class ManagePreferencesAction extends BaseAction
{
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            kkAppEng.nav.add(getCatMessage(request, "header.customer.managepreferences"), request);
            return mapping.findForward("ManagePreferencesPage");

 ...
 * page
 */
public class ChangeDeliveryAddrSubmitAction extends BaseAction
{
            ...
            HttpServletRequest request, HttpServletResponse response)
    {
        ...
        try
        {
            ...
            kkAppEng.getOrderMgr().setCheckoutOrderShippingAddress(
                    new Integer(localForm.getAddrId()).intValue());

            return mapping.findForward("CheckoutDeliveryNoReset");

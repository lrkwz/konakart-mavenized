 ...
 */
public class KKGWTInvalidSessionException extends Exception implements IsSerializable
{
     ...
     * 
     */
    public KKGWTInvalidSessionException()
    {
     ...
     * @param msg
     */
    public KKGWTInvalidSessionException(String msg)
    {
        super(msg);
    }
     ...
     */
    public KKGWTInvalidSessionException(Throwable nested)
    {
     ...
     *            the exception or error that caused this exception to be thrown.
     */
    public KKGWTInvalidSessionException(String msg, Throwable nested)
    {
        super(msg + "\n" + nested.getMessage());
    }

...
public class KKCustomEng implements com.konakart.appif.KKEngIf
{
    ...
    */
     ...
     * <p>
     * The Manufacturer objects are not complete. Only the name and the image are returned and these
     ...
     * sorted by name.
     * <p>
     * The Manufacturer objects are not complete. Only the name and the image and custom fields 1
     * and 2 are returned, and these are language independent.
     * 
     * @return Array of Manufacturer objects
     * @throws KKException
     */
    ...
    /**
     * Returns a complete Manufacturer object for the given <code>productId</code> and language.
     * 
     * @param productId
     *            The numeric id of the product
     * @param languageId
    ...
    /**
     * Returns a complete Manufacturer object for the given <code>manufacturerId</code> and
     * language.
     * 
     * @param manufacturerId
     *            The numeric id of the manufacturer
     ...
     *            sort order
     * @param orderSearch
     *            Contains information used to add serach constraints
     * @param languageId
     *            The id for the language that will be used. Value of -1 selects the default
     *            language.
     * @return An Orders object
     ...
     *            description. Value of -1 selects the default language.
     * @return Returns an array of TagGroup objects
     * @throws KKException
     */

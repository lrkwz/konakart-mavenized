...
public class KKAdminCustomEng implements com.konakartadmin.appif.KKAdminIf
{
     ...
     * @param id
     *            the language id
     * @return the language by language id
     * @throws KKAdminException
     */
     ...
     * <ul>
     * <li>KonakartAdminConstants.HTML_ORDER_DETAIL (= 1)</li>
     * <li>KonakartAdminConstants.HTML_ORDER_INVOICE (= 2)</li>
     * <li>KonakartAdminConstants.HTML_ORDER_PACKING_LIST (= 3)</li>
     * </ul>
     * 
     * @param sessionId
     *            The session Id of the logged in user
     ...
     * @return A KKConfiguration object
     * @throws KKAdminException
     */
    ...
    /**
     * Get the product referenced by this product id, from the database. The MgrOptions object
     * defines whether to use prices and quantity for the catalog defined by the catalogId.
     * 
     * @param sessionId
     *            The session Id of the logged in user
     * @param productId
     ...
     * customers in the store-front application</li>
     * <li>com.konakartadmin.bl.KonakartAdminConstants.REVIEW_INVISIBLE = The review cannot be seen
     * by customers in the store-front application. It is waiting to be approved.</li>
     * <li>com.konakartadmin.bl.KonakartAdminConstants.REVIEW_INVISIBLE_REJECTED = The review cannot
     * be seen by customers in the store-front application. It has been rejected.</li>
     * </ul>
    ...
    /**
     * Get the file contents. Note that is uses the line terminators appropriate for the platform
    ...
    /**
     * Return a set of admin application messages specified language. This is used to facilitate
     * internationalization of the KonaKart Admin application - but it could also be used to
     * internationalize any application via the KonaKart Admin API.
     * <p>
     ...
     */
     public int insertMiscItems(String sessionId, AdminMiscItem[] miTypes) throws KKAdminException
     {
         try
         {
            ...
            return _insertMiscItems.insertMiscItems(sessionId, miTypes);
         } catch (Exception e)
         {
            throw new KKAdminException(e);
         }
     ...
     */
     public void updateMiscItems(String sessionId, AdminMiscItem[] miTypes) throws KKAdminException
     {
         try
         {
            ...
            _updateMiscItems.updateMiscItems(sessionId, miTypes);
         } catch (Exception e)
         {
            throw new KKAdminException(e);
         }

...
{// Module name must be the same as the class name although it can be all in lowercase
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_TABLE_SORT_ORDER);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_TABLE_TAX_CLASS);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_TABLE_ZONE);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_TABLE_HANDLING);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_TABLE_MODE);
        if (conf == null)
        {
            staticData.setMode("");
        } else
    ...
    {
        StaticData sd = staticDataHM.get(getStoreId());
        KKConfiguration conf = getEng().getConfiguration(MODULE_SHIPPING_TABLE_COST);
        if (conf != null)
        {
    ...
    /**
     * Get a patially-filled ShippingQuote
     * 
     * @param rb
    ...
    {
        return isAvailable(getEng(), MODULE_SHIPPING_TABLE_STATUS);
    }

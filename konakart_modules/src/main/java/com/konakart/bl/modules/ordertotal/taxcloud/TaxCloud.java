...
public class TaxCloud extends BaseOrderTotalModule implements OrderTotalInterface
{
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        conf = getEng().getConfiguration(MODULE_ORDER_TOTAL_TAX_CLOUD_SORT_ORDER);
        if (conf == null)
        {
        ...
        staticData.setLoginId(getEng().getConfigurationValue(
                MODULE_ORDER_TOTAL_TAX_CLOUD_API_LOGIN_ID));
        staticData.setLoginKey(getEng().getConfigurationValue(
                MODULE_ORDER_TOTAL_TAX_CLOUD_API_LOGIN_KEY));
        staticData.setAddress1(getEng().getConfigurationValue(
                MODULE_ORDER_TOTAL_TAX_CLOUD_STORE_ADDRESS1));
        staticData.setAddress2(getEng().getConfigurationValue(
                MODULE_ORDER_TOTAL_TAX_CLOUD_STORE_ADDRESS2));
        staticData.setCity(getEng().getConfigurationValue(MODULE_ORDER_TOTAL_TAX_CLOUD_STORE_CITY));
        staticData.setState(getEng()
                .getConfigurationValue(MODULE_ORDER_TOTAL_TAX_CLOUD_STORE_STATE));
        staticData.setZip(getEng().getConfigurationValue(MODULE_ORDER_TOTAL_TAX_CLOUD_STORE_ZIP));
        staticData.setUspsId(getEng().getConfigurationValue(
                MODULE_ORDER_TOTAL_TAX_CLOUD_USPS_USER_ID));
    ...
    {
        return isAvailable(getEng(), MODULE_ORDER_TOTAL_TAX_CLOUD_STATUS);
    }

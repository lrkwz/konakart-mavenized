...
public class Authorizenet extends BasePaymentModule implements PaymentInterface
{
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        String confVal = getEng().getConfigurationValue(MODULE_PAYMENT_AUTHORIZENET_REQUEST_URL);
        if (confVal == null)
        {
        ...
        confVal = getEng().getConfigurationValue(MODULE_PAYMENT_AUTHORIZENET_LOGIN);
        if (confVal == null)
        {
            throw new KKException(
        ...
        confVal = getEng().getConfigurationValue(MODULE_PAYMENT_AUTHORIZENET_TXNKEY);
        if (confVal == null)
        {
            throw new KKException(
        ...
        staticData.setTestMode(getEng().getConfigurationValueAsBool(
                MODULE_PAYMENT_AUTHORIZENET_TESTMODE, true));
        staticData.setZone(getEng().getConfigurationValueAsIntWithDefault(
        ...
        staticData.setShowCVV(getEng().getConfigurationValueAsBool(
    ...
    {
        return isAvailable(getEng(), MODULE_PAYMENT_AUTHORIZENET_STATUS);
    }

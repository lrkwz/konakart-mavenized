...
public class Eway_au extends BasePaymentModule implements PaymentInterface
{
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_EWAY_AU_ACCOUNT_ID);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_EWAY_AU_REQUEST_URL);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_EWAY_AU_ZONE);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_EWAY_AU_SORT_ORDER);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_EWAY_AU_SHOW_CVV);
        if (conf == null)
        {
    ...
    {
        return isAvailable(getEng(), MODULE_PAYMENT_EWAY_AU_STATUS);
    }

...
package com.konakart.bl.modules.shipping.pickupinstore;
...
/**
 * This shipping module implements a "pick Up in Store" module regardless of zone. It applies to all
 * products and always returns an amount of 0.
 */
public class PickUpInStore extends BaseShippingModule implements ShippingInterface
{// Module name must be the same as the class name although it can be all in lowercase
    private static String code = "pickupinstore";

    private static String icon = "";

    private static String bundleName = BaseModule.basePackage
            + ".shipping.pickupinstore.PickUpInStore";

    private static HashMap<Locale, ResourceBundle> resourceBundleMap = new HashMap<Locale, ResourceBundle>();

    private static String mutex = "pickUpInStoreMutex";
    ...
    private final static String MODULE_SHIPPING_PICKUP_IN_STORE_SORT_ORDER = "MODULE_SHIPPING_PICKUP_IN_STORE_SORT_ORDER";

    private final static String MODULE_SHIPPING_PICKUP_IN_STORE_STATUS = "MODULE_SHIPPING_PICKUP_IN_STORE_STATUS";

    // Message Catalogue Keys

    private final static String MODULE_SHIPPING_PICKUP_IN_STORE_TEXT_TITLE = "module.shipping.pickupinstore.text.title";

    private final static String MODULE_SHIPPING_PICKUP_IN_STORE_TEXT_DESCRIPTION = "module.shipping.pickupinstore.text.description";

    private final static String MODULE_SHIPPING_PICKUP_IN_STORE_TEXT_NOTE = "module.shipping.pickupinstore.text.note";
     ...
     * 
     */
    public PickUpInStore(KKEngIf eng) throws TorqueException, KKException, DataSetException
    {
        super.init(eng);
    ...
    public ShippingQuote getQuote(Order order, ShippingInfo info) throws Exception
    {
        ...
        retTextBuf.append(rb.getString(MODULE_SHIPPING_PICKUP_IN_STORE_TEXT_NOTE));
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        staticData.setSortOrder(getEng().getConfigurationValueAsIntWithDefault(
                MODULE_SHIPPING_PICKUP_IN_STORE_SORT_ORDER, 0));
    }
    ...
    private ShippingQuote getShippingQuote(ResourceBundle rb) throws KKException
    {
        ...
        quote.setDescription(rb.getString(MODULE_SHIPPING_PICKUP_IN_STORE_TEXT_DESCRIPTION));
        quote.setTitle(rb.getString(MODULE_SHIPPING_PICKUP_IN_STORE_TEXT_TITLE));
    ...
    {
        return isAvailable(getEng(), MODULE_SHIPPING_PICKUP_IN_STORE_STATUS);
    }

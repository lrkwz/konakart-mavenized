...
{// Module name must be the same as the class name although it can be all in lowercase
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        staticData.setTaxClass(getEng().getConfigurationValueAsIntWithDefault(
        ...
        staticData.setCost(getEng().getConfigurationValueAsBigDecimalWithDefault(
    ...
    {
        return isAvailable(getEng(), MODULE_SHIPPING_FLAT_STATUS);
    }

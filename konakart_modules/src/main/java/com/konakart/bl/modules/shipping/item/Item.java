...
{// Module name must be the same as the class name although it can be all in lowercase
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_ITEM_SORT_ORDER);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_ITEM_TAX_CLASS);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_ITEM_ZONE);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_ITEM_COST);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_ITEM_HANDLING);
        if (conf == null)
        {
    ...
    {
        return isAvailable(getEng(), MODULE_SHIPPING_ITEM_STATUS);
    }

...
public class Cod extends BasePaymentModule implements PaymentInterface
{
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        staticData.setZone(getEng().getConfigurationValueAsIntWithDefault(MODULE_PAYMENT_COD_ZONE,
                0));
        staticData.setSortOrder(getEng().getConfigurationValueAsIntWithDefault(
                MODULE_PAYMENT_COD_SORT_ORDER, 0));
        staticData.setOrderStatusId(getEng().getConfigurationValueAsIntWithDefault(
    ...
    {
        return isAvailable(getEng(), MODULE_PAYMENT_COD_STATUS);
    }

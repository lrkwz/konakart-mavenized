...
public class CyberSourceHOP extends BasePaymentModule implements PaymentInterface
{
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_CYBERSOURCEHOP_REQUEST_URL);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_CYBERSOURCEHOP_RESPONSE_URL);
        if (conf == null)
        {
            throw new KKException(
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_CYBERSOURCEHOP_MERCHANT_ACC);
        if (conf == null)
        {
            throw new KKException(
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_CYBERSOURCEHOP_SHARED_SECRET);
        if (conf == null)
        {
            throw new KKException(
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_CYBERSOURCEHOP_SERIAL_NUMBER);
        if (conf == null)
        {
            throw new KKException(
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_CYBERSOURCEHOP_VERSION);
        if (conf == null)
        {
            throw new KKException(
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_CYBERSOURCEHOP_ZONE);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_CYBERSOURCEHOP_SORT_ORDER);
        if (conf == null)
        {
    ...
    public PaymentDetails getPaymentDetails(Order order, PaymentInfo info) throws Exception
    {
        ...
        if (bName != null)
        {
            ...
            parmList.add(new NameValue(CYBERSOURCEHOP_BILLTO_FNAME, names[0]));
            parmList.add(new NameValue(CYBERSOURCEHOP_BILLTO_LNAME, names[1]));
        }
        ...
        if (dName != null)
        {
            ...
            parmList.add(new NameValue(CYBERSOURCEHOP_SHIPTO_FNAME, names[0]));
            parmList.add(new NameValue(CYBERSOURCEHOP_SHIPTO_LNAME, names[1]));
        }
    ...
    {
        return isAvailable(getEng(), MODULE_PAYMENT_CYBERSOURCEHOP_STATUS);
    }

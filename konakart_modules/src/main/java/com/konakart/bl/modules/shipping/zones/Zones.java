...
{// Module name must be the same as the class name although it can be all in lowercase
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_ZONES_SORT_ORDER);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_SHIPPING_ZONES_TAX_CLASS);
        if (conf == null)
        {
    ...
    {
        return isAvailable(getEng(), MODULE_SHIPPING_ZONES_STATUS);
    }

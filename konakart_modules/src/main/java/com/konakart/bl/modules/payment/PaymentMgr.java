...
public class PaymentMgr extends BaseMgr implements PaymentMgrIf
{
    ...
    public void refreshConfigs() throws Exception
    {
        synchronized (mutex)
        {
            ...
            String modulesString = mgr.getConfigurationValue(MODULE_PAYMENT_INSTALLED);
            ...
            String storeName = mgr.getConfigurationValue(ConfigConstants.STORE_NAME);
            if (storeName == null)
            {
            ...
            sd.setDisplayPriceWithTax(mgr.getConfigurationValueAsBool(
            ...
            throws Exception
    {
        ...
        PaymentDetails[] paymentDetails = getPaymentGatewaysPrivate(order, moduleName, languageId);

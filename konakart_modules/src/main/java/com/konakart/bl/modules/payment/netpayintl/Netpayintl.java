...
public class Netpayintl extends BasePaymentModule implements PaymentInterface
{
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_NETPAYINTL_REQUEST_URL);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_NETPAYINTL_LOGIN);
        if (conf == null)
        {
            throw new KKException(
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_NETPAYINTL_ZONE);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_NETPAYINTL_SORT_ORDER);
        if (conf == null)
        {
    ...
    {
        return isAvailable(getEng(), MODULE_PAYMENT_NETPAYINTL_STATUS);
    }

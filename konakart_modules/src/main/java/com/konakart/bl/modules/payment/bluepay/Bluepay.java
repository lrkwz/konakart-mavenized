...
public class Bluepay extends BasePaymentModule implements PaymentInterface
{
    ...
    public void setStaticVariables() throws KKException
    {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_BLUEPAY_ACCOUNT_ID);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_BLUEPAY_REQUEST_URL);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_BLUEPAY_ZONE);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_BLUEPAY_SORT_ORDER);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_BLUEPAY_ORDER_STATUS_ID);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_BLUEPAY_TESTMODE);
        if (conf == null)
        {
        ...
        conf = getEng().getConfiguration(MODULE_PAYMENT_BLUEPAY_SHOW_CVV);
        if (conf == null)
        {
    ...
    {
        return isAvailable(getEng(), MODULE_PAYMENT_BLUEPAY_STATUS);
    }

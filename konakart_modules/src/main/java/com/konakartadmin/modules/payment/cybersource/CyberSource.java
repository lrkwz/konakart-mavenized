...
package com.konakartadmin.modules.payment.cybersource;
...
/**
 * CyberSource Silent Order Post payment module
 */
public class CyberSource extends PaymentModule
{
    /**
    ...
    public String getConfigKeyStub()
    {
        ...
        {
            setConfigKeyStub(super.getConfigKeyStub() + "_CYBERSOURCE");
        }
    ...
    {
        return getMsgs().getString("MODULE_PAYMENT_CYBERSOURCE_TEXT_TITLE");
    }
    ...
    public KKConfiguration[] getConfigs()
    {
        ...
        configs[i] = new KKConfiguration(
                /* title */"CyberSource SOP Status",
                /* key */"MODULE_PAYMENT_CYBERSOURCE_STATUS",
                /* value */"true",
                /* description */"If set to false, the CyberSource Silent Order Post module will be unavailable",
                /* groupId */groupId,
                /* sortO */i++,
                /* useFun */"",
        ...
        configs[i] = new KKConfiguration(
                ...
                /* key */"MODULE_PAYMENT_CYBERSOURCE_SORT_ORDER",
                /* value */"0",
                /* description */"Sort Order of CyberSource Silent Order Post module on the UI. Lowest is displayed first.",
                /* groupId */groupId,
                /* sortO */i++,
                /* useFun */"",
                /* setFun */"",
        ...
        configs[i] = new KKConfiguration(
                ...
                /* key */"MODULE_PAYMENT_CYBERSOURCE_ZONE",
                /* value */"0",
        ...
        /* key */"MODULE_PAYMENT_CYBERSOURCE_CALLBACK_USERNAME",
        ...
        /* key */"MODULE_PAYMENT_CYBERSOURCE_CALLBACK_PASSWORD",
        /* value */"princess",
        ...
        configs[i] = new KKConfiguration(
                /* title */"Shared Secret",
                /* key */"MODULE_PAYMENT_CYBERSOURCE_SHARED_SECRET",
        ...
        configs[i] = new KKConfiguration(
                /* title */"Serial Number",
                /* key */"MODULE_PAYMENT_CYBERSOURCE_SERIAL_NUMBER",
        ...
        configs[i] = new KKConfiguration(
        /* title */"Request URL",
        /* key */"MODULE_PAYMENT_CYBERSOURCE_REQUEST_URL",
        /* value */"https://orderpagetest.ic3.com/hop/ProcessOrder.do",
        /* description */"URL used by KonaKart to send the transaction details. "
                + "(Production URL is https://orderpage.ic3.com/hop/ProcessOrder.do)",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"",
        ...
        configs[i] = new KKConfiguration(
        /* title */"Response URL",
        /* key */"MODULE_PAYMENT_CYBERSOURCE_RESPONSE_URL",
        /* value */"http://host:port/konakart/CyberSourceResponse.do",
        ...
        /* key */"MODULE_PAYMENT_CYBERSOURCE_MERCHANT_ACC",
        ...
        /* key */"MODULE_PAYMENT_CYBERSOURCE_VERSION",
        /* value */"7",

...
public class WorldPayXMLRedirect extends PaymentModule
{
    ...
    public KKConfiguration[] getConfigs()
    {
        ...
        configs[i] = new KKConfiguration(
                ...
                /* value */"https://secure-test.wp3.rbsworldpay.com/jsp/merchant/xml/paymentService.jsp",
                /* description */"URL used by KonaKart to send the transaction details. "
                        + "(Production URL is  https://secure.wp3.rbsworldpay.com/jsp/merchant/xml/paymentService.jsp)",
                /* groupId */groupId,
                /* sortO */i++,
                /* useFun */"",
                /* setFun */"",
        ...
        /* value */"http://localhost:8780/konakart/WorldPayXMLRedirectResponse.do",

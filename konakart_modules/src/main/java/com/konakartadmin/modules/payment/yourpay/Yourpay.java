...
public class Yourpay extends PaymentModule
{
    ...
    public KKConfiguration[] getConfigs()
    {
        ...
        /* value */"https://www.yourdomain.com:8780/konakart/EditCartSubmit.do",
        ...
        configs[i] = new KKConfiguration(
        /* title */"Debug",
        /* key */"MODULE_PAYMENT_YOURPAY_DEBUG_MODE",
        /* value */"true",
        /* description */"Set to 'true' to enable debug mode, set to 'false' to disable it",
        /* groupId */groupId,
        /* sortO */i++,
        /* useFun */"",
        /* setFun */"tep_cfg_select_option(array('true', 'false'), ",

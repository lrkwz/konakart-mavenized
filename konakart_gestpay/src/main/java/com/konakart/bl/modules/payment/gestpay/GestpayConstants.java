...
public class GestpayConstants {
	...
	public static final String MODULE_PAYMENT_GESTPAY_SEND_CURRENCY = "MODULE_PAYMENT_GESTPAY_SEND_CURRENCY";
	public static final int FORCE_SEND = 1;
	public static final String MODULE_PAYMENT_GESTPAY_USE_ORDERNUMBER = "MODULE_PAYMENT_GESTPAY_USE_ORDERNUMBER";
